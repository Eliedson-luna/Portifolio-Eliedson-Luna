...
export function Topic({ textSize = "medium", children, className = "", align = "left", ...rest }: TextProps) {
    const sizes = {
    ...
    return (
        <span className={`${size} ${alignment} ${className} text-text-topic caret-transparent`} {...rest}>
           • {children}
        </span>
    );
}
